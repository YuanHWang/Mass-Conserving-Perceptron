...
class MCPBRNN_Generic_PETconstraint_MIloss(nn.Module):
    ...
    def __init__(self,
        ...
        super(MCPBRNN_Generic_PETconstraint_MIloss, self).__init__()
    ...
    def forward(self, x, epoch, time_lag, y_obs, cmean, cstd):
        ...
        for b in range(0+time_lag, batch_size):
            ...
            # calculate gates            
                ...
                u2_Gate = (u2.expand(1, self.gate_dim_o))
...
class MCPBRNN_Generic_PETconstraint_MIloss_Sigmoid(nn.Module):
    ...
    def __init__(self,
                 ...
                 hidden_size: int = 1,
                 initial_forget_bias: int = 0):
        super(MCPBRNN_Generic_PETconstraint_MIloss_Sigmoid, self).__init__()
