...
CaseName = 'results_MI/MI-lossGate-dim' + str(gate_dim_l)

if gate_dim_l==5 and gate_dim_o==1:
   Ini_dir = "results_MI/MI-lossGate-dim5/MCPBRNN_PETconstraint_Generic_1Layer_1node_outdim1_MI_lossdim5_6/model_epoch1.pt"
elif gate_dim_l==1 and gate_dim_o==1:
   Ini_dir = "results_MI/MI-lossGate-dim1/MCPBRNN_PETconstraint_Generic_1Layer_1node_outdim1_MI_lossdim1_9/model_epoch18.pt"
elif gate_dim_l==2 and gate_dim_o==1:
   Ini_dir = "results_MI/MI-lossGate-dim2/MCPBRNN_PETconstraint_Generic_1Layer_1node_outdim1_MI_lossdim2_10/model_epoch4.pt"
elif gate_dim_l==3 and gate_dim_o==1:
   Ini_dir = "results_MI/MI-lossGate-dim3/MCPBRNN_PETconstraint_Generic_1Layer_1node_outdim1_MI_lossdim3_1/model_epoch2.pt"
elif gate_dim_l==4 and gate_dim_o==1:
   Ini_dir = "results_MI/MI-lossGate-dim4/MCPBRNN_PETconstraint_Generic_1Layer_1node_outdim1_MI_lossdim4_5/model_epoch2.pt"
