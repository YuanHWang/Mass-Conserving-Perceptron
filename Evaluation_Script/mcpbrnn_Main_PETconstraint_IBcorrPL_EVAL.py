...
CaseName = "results_IBCorr/IBCorrPL-dim" + str(gate_dim_ucorr) + "/"

# Initialize
if gate_dim_ucorr == 1:
    weight_file = "results_IBCorr/IBCorrPL-dim1/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim1_1Layer_1node_7/model_epoch7.pt"    

elif gate_dim_ucorr == 2:
    weight_file = "results_IBCorr/IBCorrPL-dim2/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim2_1Layer_1node_7/model_epoch10.pt"

elif gate_dim_ucorr == 3:
    weight_file = "results_IBCorr/IBCorrPL-dim3/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim3_1Layer_1node_7/model_epoch7.pt"

elif gate_dim_ucorr == 4:
    weight_file = "results_IBCorr/IBCorrPL-dim4/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim4_1Layer_1node_7/model_epoch10.pt"

elif gate_dim_ucorr == 5:
    weight_file = "results_IBCorr/IBCorrPL-dim5/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim5_1Layer_1node_7/model_epoch7.pt"
