...
CaseName = "results_IBCorr/IBCorrPQ-dim" + str(gate_dim_ucorr) + "/"

# Initialize
if gate_dim_ucorr == 1:
    weight_file = "results_IBCorr/IBCorrPQ-dim1/MCPBRNN_PETconstraint_Generic_IBCorrPQ_dim1_1Layer_1node_6/model_epoch17.pt"    

elif gate_dim_ucorr == 2:
    weight_file = "results_IBCorr/IBCorrPQ-dim2/MCPBRNN_PETconstraint_Generic_IBCorrPQ_dim2_1Layer_1node_7/model_epoch20.pt"

elif gate_dim_ucorr == 3:
    weight_file = "results_IBCorr/IBCorrPQ-dim3/MCPBRNN_PETconstraint_Generic_IBCorrPQ_dim3_1Layer_1node_3/model_epoch6.pt"

elif gate_dim_ucorr == 4:
    weight_file = "results_IBCorr/IBCorrPQ-dim4/MCPBRNN_PETconstraint_Generic_IBCorrPQ_dim4_1Layer_1node_2/model_epoch17.pt"

elif gate_dim_ucorr == 5:
    weight_file = "results_IBCorr/IBCorrPQ-dim5/MCPBRNN_PETconstraint_Generic_IBCorrPQ_dim5_1Layer_1node_2/model_epoch17.pt"
