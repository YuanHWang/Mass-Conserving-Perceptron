...
parser.add_argument('--gate_dim_o',
                        type=int,
                        default=1,
                        help="number of output gate")

parser.add_argument('--gate_dim_l',
                        type=int,
                        default=1,
                        help="number of loss gate")
...
CaseName = 'results_MI/MI-Highdim/dim-o-' + str(gate_dim_o) + '-dim-l-' + str(gate_dim_l) 

if gate_dim_l==1 and gate_dim_o==1:
   Ini_dir ="results_MI/MI-Highdim/dim-o-1-dim-l-1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_MI_lossdim1_1/model_epoch58.pt"
elif gate_dim_l==2 and gate_dim_o==1:
   Ini_dir ="results_MI/MI-Highdim/dim-o-1-dim-l-2/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_MI_lossdim2_1/model_epoch64.pt"
elif gate_dim_l==3 and gate_dim_o==1:
   Ini_dir ="results_MI/MI-Highdim/dim-o-1-dim-l-3/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_MI_lossdim3_1/model_epoch65.pt"
elif gate_dim_l==4 and gate_dim_o==1:
   Ini_dir ="results_MI/MI-Highdim/dim-o-1-dim-l-4/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_MI_lossdim4_1/model_epoch38.pt"
elif gate_dim_l==5 and gate_dim_o==1:
   Ini_dir ="results_MI/MI-Highdim/dim-o-1-dim-l-5/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_MI_lossdim5_1/model_epoch56.pt"
elif gate_dim_l==1 and gate_dim_o==2:
   Ini_dir ="results_MI/MI-Highdim/dim-o-2-dim-l-1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim2_MI_lossdim1_1/model_epoch50.pt" 
elif gate_dim_l==2 and gate_dim_o==2:
   Ini_dir ="results_MI/MI-Highdim/dim-o-2-dim-l-2/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim2_MI_lossdim2_1/model_epoch56.pt" 
elif gate_dim_l==3 and gate_dim_o==2:
   Ini_dir ="results_MI/MI-Highdim/dim-o-2-dim-l-3/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim2_MI_lossdim3_1/model_epoch57.pt" 
elif gate_dim_l==4 and gate_dim_o==2:
   Ini_dir ="results_MI/MI-Highdim/dim-o-2-dim-l-4/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim2_MI_lossdim4_1/model_epoch50.pt" 
elif gate_dim_l==5 and gate_dim_o==2:
   Ini_dir ="results_MI/MI-Highdim/dim-o-2-dim-l-5/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim2_MI_lossdim5_1/model_epoch33.pt" 
elif gate_dim_l==1 and gate_dim_o==3:
   Ini_dir ="results_MI/MI-Highdim/dim-o-3-dim-l-1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim3_MI_lossdim1_1/model_epoch51.pt" 
elif gate_dim_l==2 and gate_dim_o==3:
   Ini_dir ="results_MI/MI-Highdim/dim-o-3-dim-l-2/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim3_MI_lossdim2_1/model_epoch57.pt" 
elif gate_dim_l==3 and gate_dim_o==3:
   Ini_dir ="results_MI/MI-Highdim/dim-o-3-dim-l-3/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim3_MI_lossdim3_1/model_epoch58.pt" 
elif gate_dim_l==4 and gate_dim_o==3:
   Ini_dir ="results_MI/MI-Highdim/dim-o-3-dim-l-4/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim3_MI_lossdim4_1/model_epoch59.pt" 
elif gate_dim_l==5 and gate_dim_o==3:
   Ini_dir ="results_MI/MI-Highdim/dim-o-3-dim-l-5/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim3_MI_lossdim5_1/model_epoch41.pt" 
elif gate_dim_l==1 and gate_dim_o==4:
   Ini_dir ="results_MI/MI-Highdim/dim-o-4-dim-l-1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim4_MI_lossdim1_1/model_epoch48.pt" 
elif gate_dim_l==2 and gate_dim_o==4:
   Ini_dir ="results_MI/MI-Highdim/dim-o-4-dim-l-2/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim4_MI_lossdim2_1/model_epoch53.pt" 
elif gate_dim_l==3 and gate_dim_o==4:
   Ini_dir ="results_MI/MI-Highdim/dim-o-4-dim-l-3/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim4_MI_lossdim3_1/model_epoch55.pt" 
elif gate_dim_l==4 and gate_dim_o==4:
   Ini_dir ="results_MI/MI-Highdim/dim-o-4-dim-l-4/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim4_MI_lossdim4_1/model_epoch60.pt" 
elif gate_dim_l==5 and gate_dim_o==4:
   Ini_dir ="results_MI/MI-Highdim/dim-o-4-dim-l-5/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim4_MI_lossdim5_1/model_epoch41.pt" 
elif gate_dim_l==1 and gate_dim_o==5:
   Ini_dir ="results_MI/MI-Highdim/dim-o-5-dim-l-1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim5_MI_lossdim1_1/model_epoch48.pt" 
elif gate_dim_l==2 and gate_dim_o==5:
   Ini_dir ="results_MI/MI-Highdim/dim-o-5-dim-l-2/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim5_MI_lossdim2_1/model_epoch54.pt" 
elif gate_dim_l==3 and gate_dim_o==5:
   Ini_dir ="results_MI/MI-Highdim/dim-o-5-dim-l-3/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim5_MI_lossdim3_1/model_epoch55.pt" 
elif gate_dim_l==4 and gate_dim_o==5:
   Ini_dir ="results_MI/MI-Highdim/dim-o-5-dim-l-4/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim5_MI_lossdim4_1/model_epoch61.pt" 
elif gate_dim_l==5 and gate_dim_o==5:
   Ini_dir ="results_MI/MI-Highdim/dim-o-5-dim-l-5/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim5_MI_lossdim5_1/model_epoch42.pt" 
