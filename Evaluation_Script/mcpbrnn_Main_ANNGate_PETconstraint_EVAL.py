...
CaseName = 'results_GateComplex/ComplexG-Highdim/dim-o-' + str(gate_dim_o) + '-dim-l-' + str(gate_dim_l) 
directory = CaseName

if gate_dim_o==1 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-1-dim-l-1/MCPBRNN_Generic_1Layer_1node_outGatedim1_lossGatedim1_1/model_epoch10.pt"
elif gate_dim_o==2 and gate_dim_l==1: 
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-2-dim-l-1/MCPBRNN_Generic_1Layer_1node_outGatedim2_lossGatedim1_1/model_epoch21.pt"
elif gate_dim_o==3 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-3-dim-l-1/MCPBRNN_Generic_1Layer_1node_outGatedim3_lossGatedim1_1/model_epoch26.pt"
elif gate_dim_o==4 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-4-dim-l-1/MCPBRNN_Generic_1Layer_1node_outGatedim4_lossGatedim1_1/model_epoch20.pt"
elif gate_dim_o==5 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-5-dim-l-1/MCPBRNN_Generic_1Layer_1node_outGatedim5_lossGatedim1_1/model_epoch20.pt"
elif gate_dim_o==1 and gate_dim_l==2:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-1-dim-l-2/MCPBRNN_Generic_1Layer_1node_outGatedim1_lossGatedim2_1/model_epoch10.pt"
elif gate_dim_o==2 and gate_dim_l==2: 
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-2-dim-l-2/MCPBRNN_Generic_1Layer_1node_outGatedim2_lossGatedim2_1/model_epoch20.pt"
elif gate_dim_o==3 and gate_dim_l==2:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-3-dim-l-2/MCPBRNN_Generic_1Layer_1node_outGatedim3_lossGatedim2_1/model_epoch13.pt"
elif gate_dim_o==4 and gate_dim_l==2:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-4-dim-l-2/MCPBRNN_Generic_1Layer_1node_outGatedim4_lossGatedim2_1/model_epoch29.pt"
elif gate_dim_o==5 and gate_dim_l==2:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-5-dim-l-2/MCPBRNN_Generic_1Layer_1node_outGatedim5_lossGatedim2_1/model_epoch28.pt"
elif gate_dim_o==1 and gate_dim_l==3:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-1-dim-l-3/MCPBRNN_Generic_1Layer_1node_outGatedim1_lossGatedim3_1/model_epoch32.pt"
elif gate_dim_o==2 and gate_dim_l==3: 
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-2-dim-l-3/MCPBRNN_Generic_1Layer_1node_outGatedim2_lossGatedim3_1/model_epoch30.pt"
elif gate_dim_o==3 and gate_dim_l==3:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-3-dim-l-3/MCPBRNN_Generic_1Layer_1node_outGatedim3_lossGatedim3_1/model_epoch30.pt"
elif gate_dim_o==4 and gate_dim_l==3:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-4-dim-l-3/MCPBRNN_Generic_1Layer_1node_outGatedim4_lossGatedim3_1/model_epoch22.pt"
elif gate_dim_o==5 and gate_dim_l==3:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-5-dim-l-3/MCPBRNN_Generic_1Layer_1node_outGatedim5_lossGatedim3_1/model_epoch22.pt"

elif gate_dim_o==1 and gate_dim_l==4:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-1-dim-l-4/MCPBRNN_Generic_1Layer_1node_outGatedim1_lossGatedim4_1/model_epoch31.pt"
elif gate_dim_o==2 and gate_dim_l==4: 
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-2-dim-l-4/MCPBRNN_Generic_1Layer_1node_outGatedim2_lossGatedim4_1/model_epoch31.pt"
elif gate_dim_o==3 and gate_dim_l==4:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-3-dim-l-4/MCPBRNN_Generic_1Layer_1node_outGatedim3_lossGatedim4_1/model_epoch29.pt"
elif gate_dim_o==4 and gate_dim_l==4:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-4-dim-l-4/MCPBRNN_Generic_1Layer_1node_outGatedim4_lossGatedim4_1/model_epoch29.pt"
elif gate_dim_o==5 and gate_dim_l==4:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-5-dim-l-4/MCPBRNN_Generic_1Layer_1node_outGatedim5_lossGatedim4_1/model_epoch22.pt"

elif gate_dim_o==1 and gate_dim_l==5:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-1-dim-l-5/MCPBRNN_Generic_1Layer_1node_outGatedim1_lossGatedim5_1/model_epoch29.pt"
elif gate_dim_o==2 and gate_dim_l==5: 
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-2-dim-l-5/MCPBRNN_Generic_1Layer_1node_outGatedim2_lossGatedim5_1/model_epoch33.pt"
elif gate_dim_o==3 and gate_dim_l==5:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-3-dim-l-5/MCPBRNN_Generic_1Layer_1node_outGatedim3_lossGatedim5_1/model_epoch4.pt"
elif gate_dim_o==4 and gate_dim_l==5:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-4-dim-l-5/MCPBRNN_Generic_1Layer_1node_outGatedim4_lossGatedim5_1/model_epoch25.pt"
elif gate_dim_o==5 and gate_dim_l==5:
   Ini_dir = "results_GateComplex/ComplexG-Highdim/dim-o-5-dim-l-5/MCPBRNN_Generic_1Layer_1node_outGatedim5_lossGatedim5_1/model_epoch25.pt"
