...
CaseName = 'results_GateComplex/ComplexG-loss-dim' + str(gate_dim_l) + '/' 

if gate_dim_l==1 and gate_dim_o==1:
   Ini_dir = "results_GateComplex/ComplexG-loss-dim1/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim1_10/model_epoch1.pt"
if gate_dim_l==2 and gate_dim_o==1: 
   Ini_dir = "results_GateComplex/ComplexG-loss-dim2/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim2_4/model_epoch17.pt"
elif gate_dim_l==3 and gate_dim_o==1:
   Ini_dir = "results_GateComplex/ComplexG-loss-dim3/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim3_2/model_epoch1.pt"
elif gate_dim_l==4 and gate_dim_o==1:
   Ini_dir = "results_GateComplex/ComplexG-loss-dim4/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim4_6/model_epoch5.pt"
elif gate_dim_l==5 and gate_dim_o==1:
   Ini_dir = "results_GateComplex/ComplexG-loss-dim5/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim5_5/model_epoch2.pt"
