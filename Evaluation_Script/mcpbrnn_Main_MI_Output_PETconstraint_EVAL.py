...
CaseName = 'results_MI/MI-outGate-dim' + str(gate_dim_o)

if gate_dim_l==1 and gate_dim_o==5:
   Ini_dir = "results_MI/MI-outGate-dim5/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim5_lossdim1_3/model_epoch6.pt"
elif gate_dim_l==1 and gate_dim_o==1:
   Ini_dir = "results_MI/MI-outGate-dim1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_lossdim1_3/model_epoch90.pt"
elif gate_dim_l==1 and gate_dim_o==2:
   Ini_dir = "results_MI/MI-outGate-dim2/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim2_lossdim1_3/model_epoch3.pt"
elif gate_dim_l==1 and gate_dim_o==3:
   Ini_dir = "results_MI/MI-outGate-dim3/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim3_lossdim1_9/model_epoch9.pt"
elif gate_dim_l==1 and gate_dim_o==4:
   Ini_dir = "results_MI/MI-outGate-dim4/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim4_lossdim1_5/model_epoch5.pt"
