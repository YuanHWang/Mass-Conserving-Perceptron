...
CaseName = 'MCPBRNN_PETconstraint_Generic_' + str(depth_size) + 'Layer_1node_' + 'MI_outdim' + str(gate_dim_o) + '_lossdim' + str(gate_dim_l) + '_' + str(cfg["case_no"]) + '_Sigmoid'
directory = CaseName
...
Ini_dir = "results_MI/MI-outGate-dim1-sigmoid/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_lossdim1_4_Sigmoid/model_epoch905.pt"
...
CaseName = "results_MI/MI-outGate-dim1-sigmoid/"
