...
CaseName = 'MCPBRNN_PETconstraint_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA2'
directory = CaseName
...
weight_file = "results_temp/M2-case-MCA2-PETconstraint/MCPBRNN_PETconstraint_Generic_M21Layer_1node_1_MCA2/model_epoch2985.pt"
...
CaseName = "results_temp/M2-case-MCA2-PETconstraint/"
