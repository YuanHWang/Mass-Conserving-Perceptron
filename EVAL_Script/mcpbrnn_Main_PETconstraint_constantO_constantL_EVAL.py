...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_PETconstraint_constant_OutLoss
...
CaseName = 'MCPBRNN_Generic_PETconstraint_Scaling_M1_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_PETconstraint_constant_OutLoss(input_size=input_size_dyn,
...
weight_file = "results_temp/M1-case-PETconstraint/MCPBRNN_Generic_PETconstraint_Scaling_M1_1Layer_1node_1/model_epoch1000.pt"
...
CaseName = "results_temp/M1-case-PETconstraint/"
