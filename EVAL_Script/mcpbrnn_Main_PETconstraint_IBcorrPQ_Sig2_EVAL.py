...
import csv
# import class
from MCPBRNN_lib_tools.InputBiasCorr import MCPBRNN_PETconstraint_IBcorrPQ_Generic_sigmoid
...
CaseName = "results_IBCorr/IBCorrPQ-dim" + str(gate_dim_ucorr) + "-S2/"

# Initialize
if gate_dim_ucorr == 1:
    weight_file = "results_IBCorr/IBCorrPQ-dim1-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim1_1Layer_1node_7/model_epoch65.pt"    

elif gate_dim_ucorr == 2:
    weight_file = "results_IBCorr/IBCorrPQ-dim2-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim2_1Layer_1node_6/model_epoch1.pt"

elif gate_dim_ucorr == 3:
    weight_file = "results_IBCorr/IBCorrPQ-dim3-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim3_1Layer_1node_2/model_epoch16.pt"

elif gate_dim_ucorr == 4:
    weight_file = "results_IBCorr/IBCorrPQ-dim4-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim4_1Layer_1node_10/model_epoch7.pt"

elif gate_dim_ucorr == 5:
    weight_file = "results_IBCorr/IBCorrPQ-dim5-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim5_1Layer_1node_1/model_epoch7.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_PETconstraint_IBcorrPQ_Generic_sigmoid(input_size=input_size_dyn,
...
# Output time series
    ...
    Out_u1_BC [0:timeLen,epoch-1] = u1_BC_eval[:,0]
...
Out_file = pd.DataFrame(Out_u1_BC)
outname = CaseName + '/' + 'Out_u1_BC_' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)