...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2_BYPASSM0, MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_Generic_constantoutput_variableLoss_MCA2_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA2_BYPASSM0'
directory = CaseName
...
class Model(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval):
        ...
        out = last_h        
        return out, h_t, c_t, l_t, lc_t, gw_t, bp_t, i, oo, oogw, ol, olc, f
...
weight_file = "results_temp/M2-case-MCA2-BYPASSM0-PETconstraint/MCPBRNN_Generic_PETconstraint_M21Layer_1node_1_MCA2_BYPASSM0/model_epoch34.pt"
...
CaseName = 'results_temp/M2-case-MCA2-BYPASSM0-PETconstraint/'
...
outname = CaseName + '/' + 'Outrechage_' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)
