...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2_BYPASSM0, MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_GWConstant_Routing, MCPBRNN_Generic_constantoutput_variableLoss_MCA2_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA4_BYPASSM0'
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2_BYPASSM0(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval):
        ...
        out = last_h        
        return out, h_t, h_t_MCA4, c_t, c_t_MCA4, l_t, lc_t, gw_t, bp_t, i, oo, oo_MCA4, oogw, ol, olc, f, f_MCA4
...
weight_file = "results_temp/M2-case-MCA4-BYPASSM0-PETconstraint/MCPBRNN_Generic_PETconstraint_M21Layer_1node_1_MCA4_BYPASSM0/model_epoch2000.pt"
...
for epoch in range(1,1+1): 
    ...
    OutMatrix[epoch-1,6]= model.state_dict()["MCPBRNNNode.theltaC"][:]    
