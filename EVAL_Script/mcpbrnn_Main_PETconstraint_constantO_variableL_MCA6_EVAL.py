...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_SW_Constant_Routing, MCPBRNN_GWConstant_Routing,MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA6
...
CaseName = 'MCPBRNN_Generic_PETconstraint_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA6'
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA6(input_size=input_size_dyn,
...
Ini_dir = "results_temp/M2-case-MCA6-PETconstraint/MCPBRNN_Generic_PETconstraint_M21Layer_1node_1_MCA6/model_epoch2997.pt"
...
CaseName = 'results_temp/M2-case-MCA6-PETconstraint/'
