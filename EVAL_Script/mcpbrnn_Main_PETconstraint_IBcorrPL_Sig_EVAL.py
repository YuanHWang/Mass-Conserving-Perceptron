...
CaseName = "results_IBCorr/IBCorrPL-dim" + str(gate_dim_ucorr) + "-S/"

# Initialize
if gate_dim_ucorr == 1:
    weight_file = "results_IBCorr/IBCorrPL-dim1-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim1_1Layer_1node_5/model_epoch5.pt"    

elif gate_dim_ucorr == 2:
    weight_file = "results_IBCorr/IBCorrPL-dim2-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim2_1Layer_1node_4/model_epoch3.pt"

elif gate_dim_ucorr == 3:
    weight_file = "results_IBCorr/IBCorrPL-dim3-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim3_1Layer_1node_2/model_epoch6.pt"

elif gate_dim_ucorr == 4:
    weight_file = "results_IBCorr/IBCorrPL-dim4-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim4_1Layer_1node_2/model_epoch6.pt"

elif gate_dim_ucorr == 5:
    weight_file = "results_IBCorr/IBCorrPL-dim5-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim5_1Layer_1node_10/model_epoch5.pt"
