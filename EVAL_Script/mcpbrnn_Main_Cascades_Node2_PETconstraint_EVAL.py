...
import csv
# import class
from MCPBRNN_lib_tools.CascadeZoo_New import MCPBRNN_Cascade_1tank_PETconstraint_Generic_New, MCPBRNN_Cascade_2tank_PETconstraint_Generic_New 
...
CaseName = 'MCPBRNN_PETconstraint_Generic_Cascade2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
Ini_dir = "results_Cascade/Cascade-2Nodes/MCPBRNN_PETconstraint_Generic_Cascade2_1Layer_1node_9/model_epoch80.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Cascade_2tank_PETconstraint_Generic_New(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, mo, so, mo2, so2, mu, su):
        ...
        out_hn, h_t, c_t, l_t, lc_t, bp_t, ib, oo, ol, f, olc, h_t_tank2, c_t_tank2, l_t_tank2, lc_t_tank2, bp_t_tank2, ib_tank2, Gate_oo_tank2, ol_tank2, f_tank2, olc_tank2 = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval, mo, so, mo2, so2, mu, su)    
        last_h = self.dropout(out_hn)      
        out = last_h        
        return out, h_t, c_t, l_t, lc_t, bp_t, ib, oo, ol, f, olc, h_t_tank2, c_t_tank2, l_t_tank2, lc_t_tank2, bp_t_tank2, ib_tank2, Gate_oo_tank2, ol_tank2, f_tank2, olc_tank2
...
for epoch in range(1,1+1): 
    ...
    for data in pbar:
        ...
        predictions = model(x,epoch, time_lag, y, mo, so, mo2, so2, mu, su)[0]      
    ...
    Result = model(x,epoch, time_lag, y, mo, so, mo2, so2, mu, su)
...
#    OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.weight_b1_yum"][:]
#    OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode.weight_b2_yum"][:]
#    OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode.bias_b0_yum"][:]
#    OutMatrix[epoch-1,10]= model.state_dict()["MCPBRNNNode.weight_r_yom_tank2"][:]
#    OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode.weight_r_ylm_tank2"][:]
#    OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode.weight_r_yfm_tank2"][:]
#    OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode.bias_b0_yom_tank2"][:]
#    OutMatrix[epoch-1,14]= model.state_dict()["MCPBRNNNode.weight_b1_yom_tank2"][:]
#    OutMatrix[epoch-1,15]= model.state_dict()["MCPBRNNNode.bias_b0_ylm_tank2"][:]
#    OutMatrix[epoch-1,16]= model.state_dict()["MCPBRNNNode.weight_b2_ylm_tank2"][:]
...
CaseName =  "results_Cascade/Cascade-2Nodes/"
# Save Results file
#outtofile = pd.DataFrame(OutMatrix, columns=["MCPBRNNNode.weight_r_yom","MCPBRNNNode.weight_r_ylm","MCPBRNNNode.weight_r_yfm","MCPBRNNNode.bias_b0_yom","MCPBRNNNode.weight_b1_yom","MCPBRNNNode.bias_b0_ylm","MCPBRNNNode.weight_b2_ylm","MCPBRNNNode.weight_b1_yum","MCPBRNNNode.weight_b2_yum","MCPBRNNNode.bias_b0_yum","MCPBRNNNode.weight_r_yom_tank2","MCPBRNNNode.weight_r_ylm_tank2","MCPBRNNNode.weight_r_yfm_tank2","MCPBRNNNode.bias_b0_yom_tank2","MCPBRNNNode.weight_b1_yom_tank2","MCPBRNNNode.bias_b0_ylm_tank2","MCPBRNNNode.weight_b2_ylm_tank2",'NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
