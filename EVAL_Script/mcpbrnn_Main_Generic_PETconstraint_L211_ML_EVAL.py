...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo_SP import MCPBRNN_Generic_PETconstraint_Multi_parallel_Original, MCPBRNN_PETconstraint_Generic,MCPBRNN_Generic_PETconstraint_Multi_parallel_firstlayer, MCPBRNN_Generic_PETconstraint_Linear_Layer
...
if depth_size1==2 and depth_size2==1 and depth_size3==1:
   Ini_dir ="results_multinode/ML-Layer-2-1-1/ML_DNN_MCPBRNN_Generic_Layer-2-1-1_case_10/model_epoch500.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode_Layer1 = MCPBRNN_Generic_PETconstraint_Multi_parallel_firstlayer(input_size=input_size_dyn,
        ...
        self.MCPBRNNNode_Layer2 = MCPBRNN_PETconstraint_Generic(input_size=input_size_dyn,
        ...
        self.MCPBRNNNode_Layer3 = MCPBRNN_PETconstraint_Generic(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval):
        ...
        x_layer3 = torch.cat((h_t_layer2, x_d[:,:,1]), 1)
        x_d_layer3 = x_layer3.unsqueeze(1)
        h_t_layer3, c_t_layer3, l_t_layer3, lc_t_layer3, bp_t_layer3, i_layer3, oo_layer3, ol_layer3, ol_constraint_layer3, f_layer3, obs_std_layer3 = self.MCPBRNNNode_Layer3(x_d_layer3, epoch, time_lag, y_eval)
...
CaseName = "results_multinode/ML-Layer-2-1-1"
