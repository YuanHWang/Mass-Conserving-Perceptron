...
from MCPBRNN_lib_tools.MultiNodeZoo import MCPBRNN_Generic_PETconstraint_MultiParallel_MCA1_shareoutputGate
...
CaseName = 'MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_' + str(cfg["hidden_size"]) + '_case_' + str(cfg["case_no"]) + '_outputshared'
directory = CaseName
...
if hidden_size==2:
   Ini_dir ="results_multinode/Parallel-2Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_2_case_8_outputshared/model_epoch1668.pt"
   #Ini_dir = "../20220728-LeafRiver-40yrs-Rerun/results_temp_New/MCPBRNN_PETconstraint_Generic_1Layer_1node_1/model_epoch29.pt"
elif hidden_size==3: 
   Ini_dir = "results_multinode/Parallel-3Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_3_case_10_outputshared/model_epoch495.pt"
elif hidden_size==4:
   Ini_dir = "results_multinode/Parallel-4Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_4_case_4_outputshared/model_epoch969.pt"
elif hidden_size==5:
   Ini_dir = "results_multinode/Parallel-5Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_5_case_3_outputshared/model_epoch765.pt"
elif hidden_size==6:
   Ini_dir = "results_multinode/Parallel-6Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_6_case_3_outputshared/model_epoch152.pt"
elif hidden_size==7:
   Ini_dir = "results_multinode/Parallel-7Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_7_case_6_outputshared/model_epoch562.pt"
elif hidden_size==8:
   Ini_dir = "results_multinode/Parallel-8Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_8_case_9_outputshared/model_epoch427.pt"
elif hidden_size==9:
   Ini_dir = "results_multinode/Parallel-9Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_9_case_5_outputshared/model_epoch289.pt"
elif hidden_size==10:
   Ini_dir = "results_multinode/Parallel-10Nodes-outputshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_10_case_7_outputshared/model_epoch706.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_MultiParallel_MCA1_shareoutputGate(input_size=input_size_dyn,
...
# Save timeseries
CaseName = "results_multinode/Parallel-" + str(hidden_size) + "Nodes-outputshared/"
# Save timeseries
