...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing,MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate,MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate_BYPASSM0,MCPBRNN_GWVariant_Routing_MRRegular
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA6_BYPASSM0_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 25 # Temporarily not save the parameter value
skillmetric = 7
...
weight_file = "results_HYMOD/MCA6-BYPASS-M0_celldep-Noconstraint/MCPBRNN_Generic_PETconstraint_MCA6_BYPASSM0_CellDependent_1Layer_1node_1/model_epoch1232.pt"
...
CaseName = 'results_HYMOD/MCA6-BYPASS-M0_celldep-Noconstraint/'
