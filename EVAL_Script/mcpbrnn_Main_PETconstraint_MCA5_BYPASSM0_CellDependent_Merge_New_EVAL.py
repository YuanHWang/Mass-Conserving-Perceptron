...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate_BYPASSM0, MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing, MCPBRNN_GWVariant_Routing_MRRegular_Relaxed
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA5_BYPASSM0_CellDependent_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
weight_file = "results_HYMOD/MCA5-BYPASS-M0_celldep-Noconstraint-New/MCPBRNN_Generic_PETconstraint_MCA5_BYPASSM0_CellDependent_1Layer_1node_1/model_epoch71.pt"
...
CaseName = 'results_HYMOD/MCA5-BYPASS-M0_celldep-Noconstraint-New/'
