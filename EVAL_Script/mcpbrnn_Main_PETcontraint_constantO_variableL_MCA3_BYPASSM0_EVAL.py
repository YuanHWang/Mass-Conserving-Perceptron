...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_SW_Constant_Routing,MCPBRNN_Generic_PETconstraint_constant_Out_variableLoss_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_M2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA3_BYPASSM0'
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_constant_Out_variableLoss_BYPASSM0(input_size=input_size_dyn,
...
weight_file = "results_temp/M2-case-MCA3-BYPASSM0-PETconstraint/MCPBRNN_Generic_PETconstraint_M2_1Layer_1node_1_MCA3_BYPASSM0/model_epoch62.pt"
...
# Save Results file
CaseName = "results_temp/M2-case-MCA3-BYPASSM0-PETconstraint/"
