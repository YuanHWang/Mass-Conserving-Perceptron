...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_PETconstraint_variable_Out_constantLoss
...
CaseName = 'MCPBRNN_Generic_PETconstraint_Scaling_M3_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_variable_Out_constantLoss(input_size=input_size_dyn,
...
weight_file = "results_temp/M3-case-PETconstraint/MCPBRNN_Generic_PETconstraint_Scaling_M3_1Layer_1node_1/model_epoch55.pt"
...
CaseName = "results_temp/M3-case-PETconstraint/"
