...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_GWConstant_Routing, MCPBRNN_Generic_constantoutput_variableLoss_MCA2_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA4_BYPASSM0'
directory = CaseName
...
weight_file = "results_temp/M2-case-MCA4-BYPASSM0/MCPBRNN_Generic_M21Layer_1node_6_MCA4_BYPASSM0/model_epoch424.pt"
...
CaseName = "results_temp/M2-case-MCA4-BYPASSM0/"
