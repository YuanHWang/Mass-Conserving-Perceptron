...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_Generic_constantoutput_variableLoss_MCA2_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA2_BYPASSM0'
directory = CaseName
...
weight_file = "results_temp/M2-case-MCA2-BYPASSM0/MCPBRNN_Generic_M21Layer_1node_6_MCA2_BYPASSM0/model_epoch477.pt"
...
CaseName = 'results_temp/M2-case-MCA2-BYPASSM0/'
