...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_SW_Constant_Routing, MCPBRNN_GWConstant_Routing,MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA5_BYPASSM0'
directory = CaseName
...
weight_file = "results_temp/M2-case-MCA5-BYPASSM0-PETconstraint/MCPBRNN_Generic_PETconstraint_M21Layer_1node_1_MCA5_BYPASSM0/model_epoch2908.pt"
...
CaseName = 'results_temp/M2-case-MCA5-BYPASSM0-PETconstraint/'
