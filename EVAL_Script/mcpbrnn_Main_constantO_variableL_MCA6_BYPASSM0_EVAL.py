...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_SW_Constant_Routing, MCPBRNN_GWConstant_Routing,MCPBRNN_Generic_constantoutput_variableLoss_MCA6,MCPBRNN_Generic_constantoutput_variableLoss_MCA6_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA6_BYPASSM0'
directory = CaseName
...
Ini_dir = "results_temp/M2-case-MCA6-BYPASSM0/MCPBRNN_Generic_M21Layer_1node_1_MCA6_BYPASSM0/model_epoch2506.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_constantoutput_variableLoss_MCA6_BYPASSM0(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval):
        ...
        h_t, c_t, l_t, gw_t, bp_t, i, oo, oogw, ol, f, fp, h_nout, obs_std, h_fp_t = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval)
        ...
        out = last_h
        return out, h_t, h_t_MCA3, h_t_MCA4, c_t, c_t_MCA3, c_t_MCA4, l_t, gw_t, bp_t, i, oo, oo_MCA3, oo_MCA4, oogw, ol, f, f_MCA3, f_MCA4, fp, h_fp_t
...
for epoch in range(1,1+1): 
    ...
    fp_gate_MCA6 = Result[19]
    hidden_FP_eval = Result[20]
...
CaseName = 'results_temp/M2-case-MCA6-BYPASSM0/'
