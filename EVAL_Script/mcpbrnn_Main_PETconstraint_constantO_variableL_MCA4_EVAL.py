...
import csv
# import class
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2, MCPBRNN_GWConstant_Routing
...
CaseName = 'MCPBRNN_PETconstraint_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA4'
directory = CaseName
...
weight_file = "results_temp/M2-case-MCA4-PETconstraint/MCPBRNN_PETconstraint_Generic_M21Layer_1node_1_MCA4/model_epoch2999.pt"
...
CaseName = "results_temp/M2-case-MCA4-PETconstraint/"
