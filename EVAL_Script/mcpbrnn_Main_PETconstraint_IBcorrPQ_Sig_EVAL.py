...
CaseName = "results_IBCorr/IBCorrPQ-dim" + str(gate_dim_ucorr) + "-S/"

# Initialize
if gate_dim_ucorr == 1:
    weight_file = "results_IBCorr/IBCorrPQ-dim1-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim1_1Layer_1node_7/model_epoch65.pt"    

elif gate_dim_ucorr == 2:
    weight_file = "results_IBCorr/IBCorrPQ-dim2-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim2_1Layer_1node_6/model_epoch1.pt"

elif gate_dim_ucorr == 3:
    weight_file = "results_IBCorr/IBCorrPQ-dim3-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim3_1Layer_1node_5/model_epoch16.pt"

elif gate_dim_ucorr == 4:
    weight_file = "results_IBCorr/IBCorrPQ-dim4-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim4_1Layer_1node_6/model_epoch3.pt"

elif gate_dim_ucorr == 5:
    weight_file = "results_IBCorr/IBCorrPQ-dim5-S/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPQ_dim5_1Layer_1node_7/model_epoch16.pt"
