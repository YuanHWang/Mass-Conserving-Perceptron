...
weight_file = "results_temp/M5-case_Trial2/MCPBRNN_Generic_PETconstraint_Scaling_M5_1Layer_1node_1/model_epoch30.pt"
...
## Import Data
F_data = pd.read_csv('../20220527-MDUPLEX-LeafRiver/LeafRiverDaily_43YR_P10.txt', header=None, delimiter=r"\s+")
...
CaseName = "results_temp/M5-case_Trial2/"

Out_file = pd.DataFrame(Out_hidden)
outname = CaseName + '/' + 'Outhidden_P10_' + str(cfg["case_no"]) + '_summary.csv'
