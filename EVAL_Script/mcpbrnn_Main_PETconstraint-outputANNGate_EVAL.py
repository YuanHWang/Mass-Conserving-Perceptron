...
CaseName = 'results_GateComplex/ComplexG-out-dim' + str(gate_dim_o) + '/' 

if gate_dim_o==1 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-out-dim1/MCPBRNN_Generic_1Layer_1node_outGatedim1_lossGate_sigmoid_dim1_2_Training_M3/model_epoch5.pt"
if gate_dim_o==2 and gate_dim_l==1: 
   Ini_dir = "results_GateComplex/ComplexG-out-dim2/MCPBRNN_Generic_1Layer_1node_outGatedim2_lossGate_sigmoid_dim1_4/model_epoch7.pt"
elif gate_dim_o==3 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-out-dim3/MCPBRNN_Generic_1Layer_1node_outGatedim3_lossGate_sigmoid_dim1_6/model_epoch10.pt"
elif gate_dim_o==4 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-out-dim4/MCPBRNN_Generic_1Layer_1node_outGatedim4_lossGate_sigmoid_dim1_2/model_epoch19.pt"
elif gate_dim_o==5 and gate_dim_l==1:
   Ini_dir = "results_GateComplex/ComplexG-out-dim5/MCPBRNN_Generic_1Layer_1node_outGatedim5_lossGate_sigmoid_dim1_3/model_epoch16.pt"
