...
CaseName = 'MCPBRNN_Generic_M2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA3_BYPASSM0'
directory = CaseName
...
weight_file = "results_temp/M2-case-MCA3-BYPASSM0/MCPBRNN_Generic_M2_1Layer_1node_1_MCA3_BYPASSM0/model_epoch2399.pt"
...
# Save timeseries
CaseName = "results_temp/M2-case-MCA3-BYPASSM0/"
