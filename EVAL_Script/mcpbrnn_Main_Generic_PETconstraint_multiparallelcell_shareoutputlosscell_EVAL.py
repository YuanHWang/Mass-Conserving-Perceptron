...
from MCPBRNN_lib_tools.MultiNodeZoo import MCPBRNN_Generic_PETconstraint_MultiParallel_MCA1_shareoutputlossGate
...
CaseName = 'MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_' + str(cfg["hidden_size"]) + '_case_' + str(cfg["case_no"]) + '_outputlossshared'
directory = CaseName
...
if hidden_size==2:
   Ini_dir ="results_multinode/Parallel-2Nodes-outputlossshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_2_case_1_outputlossshared/model_epoch2750.pt"
elif hidden_size==3: 
   Ini_dir = "results_multinode/Parallel-3Nodes-outputlossshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_3_case_6_outputlossshared/model_epoch760.pt"
elif hidden_size==4:
   Ini_dir = "results_multinode/Parallel-4Nodes-outputlossshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_4_case_1_outputlossshared/model_epoch994.pt"
elif hidden_size==5:
   Ini_dir = "results_multinode/Parallel-5Nodes-outputlossshared/MCPBRNN_Generic_MCA1_1Layer_Parallel_Node_5_case_8_outputlossshared/model_epoch736.pt"
elif hidden_size==6:
   Ini_dir = "Multi-Parallel-Node5/A1_MCPBRNN_Generic_1Layer_1node_multuparallel_cell_5case_7_Training_M3/model_epoch1784.pt"
elif hidden_size==7:
   Ini_dir = "Multi-Parallel-Node6_Update/A1_MCPBRNN_Generic_1Layer_1node_multuparallel_cell_6case_8_Training_M3/model_epoch1575.pt"
elif hidden_size==8:
   Ini_dir = "Multi-Parallel-Node7/A1_MCPBRNN_Generic_1Layer_1node_multuparallel_cell_7case_1_Training_M1/model_epoch20.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_MultiParallel_MCA1_shareoutputlossGate(input_size=input_size_dyn,
...
#hnout, c_n, l_n, lc_n, bp_n, Gate_ib, Gate_oo, Gate_ol, Gate_ol_constraint, Gate_f, obs_std
        ...
        out = last_h        
        return out, h_t, c_t, l_t, bp_t, i, oo, ol, ol_constraint, f, obs_std
...
# Save Results file
CaseName = "results_multinode/Parallel-" + str(hidden_size) + "Nodes-outputlossshared/"
# Save timeseries
