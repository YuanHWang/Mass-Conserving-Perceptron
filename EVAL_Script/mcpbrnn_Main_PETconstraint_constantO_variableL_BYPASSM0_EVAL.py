...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_BYPASSM0, MCPBRNN_Generic_constant_Out_variableLoss, MCPBRNN_Generic_constant_Out_variableLoss_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_M2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_BYPASSM0'
directory = CaseName
parent_dir = "/Users/yhwang/Desktop/HPC_DownloadTemp/2023-Spring-New/20230412-Single-Node-Cases" 
Ini_dir = "results_temp/M2-case-MCA1-BYPASSM0-PETconstraint/MCPBRNN_Generic_PETconstraint_M2_1Layer_1node_1_BYPASSM0/model_epoch1995.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_BYPASSM0(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval):
        ...
        h_t, c_t, l_t, lc_t, bp_t, i, oo, ol, olc, f, h_nout, obs_std = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval)    
...
for epoch in range(1,1+1): 
    ...
    OutMatrix[epoch-1,5]= model.state_dict()["MCPBRNNNode.theltaC"][:]
...
CaseName = 'results_temp/M2-case-MCA1-BYPASSM0-PETconstraint/'
