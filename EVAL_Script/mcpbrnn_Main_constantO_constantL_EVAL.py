...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_constant_OutLoss 
...
CaseName = 'MCPBRNN_constant_OutLoss_M1_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
parent_dir = "/Users/yhwang/Desktop/HPC_DownloadTemp/2023-Spring-New/20230412-Single-Node-Cases" 
weight_file = "results_temp/M1-case/MCPBRNN_constant_OutLoss_M1_1Layer_1node_5/model_epoch42.pt"
...
par_no = 3 # Temporarily not save the parameter value
skillmetric = 7
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_constant_OutLoss(input_size=input_size_dyn,
