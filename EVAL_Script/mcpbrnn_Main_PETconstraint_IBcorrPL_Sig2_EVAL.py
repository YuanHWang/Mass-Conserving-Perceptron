...
import csv
# import class
from MCPBRNN_lib_tools.InputBiasCorr import MCPBRNN_PETconstraint_IBcorrPL_Generic_sigmoid
...
CaseName = "results_IBCorr/IBCorrPL-dim" + str(gate_dim_ucorr) + "-S2/"

# Initialize
if gate_dim_ucorr == 1:
    weight_file = "results_IBCorr/IBCorrPL-dim1-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim1_1Layer_1node_8/model_epoch3.pt"    

elif gate_dim_ucorr == 2:
    weight_file = "results_IBCorr/IBCorrPL-dim2-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim2_1Layer_1node_8/model_epoch10.pt"

elif gate_dim_ucorr == 3:
    weight_file = "results_IBCorr/IBCorrPL-dim3-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim3_1Layer_1node_2/model_epoch6.pt"

elif gate_dim_ucorr == 4:
    weight_file = "results_IBCorr/IBCorrPL-dim4-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim4_1Layer_1node_10/model_epoch10.pt"

elif gate_dim_ucorr == 5:
    weight_file = "results_IBCorr/IBCorrPL-dim5-S2/MCPBRNN_PETconstraint_Generic_sigmoid_IBCorrPL_dim5_1Layer_1node_8/model_epoch10.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_PETconstraint_IBcorrPL_Generic_sigmoid(input_size=input_size_dyn,
...
# Output time series
    ...
    Out_BC [0:timeLen,epoch-1] = BC_eval[:,0]
...
Out_file = pd.DataFrame(Out_BC)
outname = CaseName + '/' + 'Out_BC_' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)