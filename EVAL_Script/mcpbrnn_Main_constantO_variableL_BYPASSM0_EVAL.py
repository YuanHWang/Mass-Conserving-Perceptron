...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_constant_Out_variableLoss, MCPBRNN_Generic_constant_Out_variableLoss_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_M2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_BYPASSM0'
directory = CaseName
parent_dir = "/Users/yhwang/Desktop/HPC_DownloadTemp/2023-Spring-New/20230412-Single-Node-Cases" 
Ini_dir = "results_temp/M2-case-MCA1-BYPASSM0-New/MCPBRNN_Generic_M2_1Layer_1node_4_BYPASSM0/model_epoch543.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_constant_Out_variableLoss_BYPASSM0(input_size=input_size_dyn,
...
CaseName = 'results_temp/M2-case-MCA1-BYPASSM0-New/'
