...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2
...
CaseName = 'MCPBRNN_PETconstraint_Generic_MCA2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model_old(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss(input_size=input_size_dyn,
...
weight_file = "results_temp/M2-case-PETconstraint/MCPBRNN_PETconstraint_Generic_M2_1Layer_1node_1/model_epoch1995.pt"
