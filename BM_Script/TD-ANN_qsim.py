...
import glob 
# import class
from MCPBRNN_lib_tools.BMZoo import ANN_LeafRiver_Sigmoid_qsim
...
learning_rates = {500: 0.0125, 1000: 0.0125}

# Define case & directory
CaseName = 'TD-ANN-caseno' + str(cfg["case_no"]) + "_" + "PP_Lag_"  +  str(PP_input) + "Q_Lag_" + str(Q_input) + "PET_Lag_" + str(PET_input) + '_Sigmoid' + '_Qsim_Node_' + str(hidden_size)
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = ANN_LeafRiver_Sigmoid_qsim(input_size=input_size_dyn,
