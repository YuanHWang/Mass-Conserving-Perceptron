...
import glob 
# import class
from MCPBRNN_lib_tools.BMZoo import Vanilla_RNN_Sigmoid_Qsim
...
CaseName = CaseName = 'Vanilla_RNN_Sigmoid_Qsim-caseno' + str(cfg["case_no"]) + "_" + "PP_Lag_"  +  str(PP_input) + "Q_Lag_" + str(Q_input) + "PET_Lag_" + str(PET_input) + '_Sigmoid_' + str(hidden_size) + '_Node'
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = Vanilla_RNN_Sigmoid_Qsim(input_size=input_size_dyn,
