...
CaseName = 'MCPBRNN_PETconstraint_MCRelaxed_Generic_Iter1_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
Ini_dir = "MR-dependent-New/MCPBRNN_PETconstraint_MCRelaxed_Generic_1Layer_1node_3/model_epoch2000.pt"
