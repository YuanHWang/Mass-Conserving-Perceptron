...
import csv
# import class
from MCPBRNN_lib_tools.InputBiasCorr import MCPBRNN_PETconstraint_IBcorrPL_Generic
...
CaseName = 'MCPBRNN_PETconstraint_Generic_IBCorrPL_dim' + str(gate_dim_ucorr) + '_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) 
directory = CaseName
...
class Model_pre(nn.Module):
    ...
    def __init__(self,
        ...
        self.dropout_rate = dropout       
        self.batch_size = batch_size        
        self.MCPBRNNNode = MCPBRNN_PETconstraint_IBcorrPL_Generic(input_size=input_size_dyn,
                         hidden_size=hidden_size,
                         gate_dim=gate_dim,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval,c_mean,c_std):
        ...
        h_t, c_t, l_t, lc_t, bp_t, i, oo, ol, olc, f, BC_t, hn, obs_std = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval,c_mean,c_std)    
        last_h = self.dropout(h_t)      
        out = last_h        
        return out, h_t, c_t, l_t, lc_t, bp_t, i, oo, ol, olc, f, BC_t
...
if gate_dim_ucorr == 1:
    ...
    weight_file = "IBCorrPL-dim1/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim1_1Layer_1node_7/model_epoch7.pt"
    ...
    weight_file = "IBCorrPL-dim2/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim2_1Layer_1node_7/model_epoch10.pt"
    model_pre.load_state_dict(torch.load(weight_file))
    ...
    weight_file = "IBCorrPL-dim3/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim3_1Layer_1node_7/model_epoch7.pt"
    model_pre.load_state_dict(torch.load(weight_file))
    ...
    weight_file = "IBCorrPL-dim4/MCPBRNN_PETconstraint_Generic_IBCorrPL_dim4_1Layer_1node_7/model_epoch10.pt"
    model_pre.load_state_dict(torch.load(weight_file))
...
for epoch in range(1,num_epochs+1): 
    ...
    BC_eval = BC_eval.detach().cpu().numpy() 
    ...
    if gate_dim_ucorr == 1:
        ...
        OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.ln_wj"][0][0]
        OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode.relu_bj"][0][0]  
    elif gate_dim_ucorr == 2:
        OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
        OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
        OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
        ...
        OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.ln_wj"][0][0]
        OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode.relu_bj"][0][0]
        OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode.ln_wj"][1][0]
        OutMatrix[epoch-1,10]= model.state_dict()["MCPBRNNNode.relu_bj"][0][1] 
    elif gate_dim_ucorr == 3:
        OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
        OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
        OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
        ...
        OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode.ln_wj"][1][0]
        OutMatrix[epoch-1,10]= model.state_dict()["MCPBRNNNode.relu_bj"][0][1] 
        OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode.ln_wj"][2][0]
        OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode.relu_bj"][0][2]        
    elif gate_dim_ucorr == 4:
        OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
        OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
        OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
        ...
        OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode.ln_wj"][2][0]
        OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode.relu_bj"][0][2]  
        OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode.ln_wj"][3][0]
        OutMatrix[epoch-1,14]= model.state_dict()["MCPBRNNNode.relu_bj"][0][3]       
    elif gate_dim_ucorr == 5:
        OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
        OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
        OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
        ...
        OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode.ln_wj"][3][0]
        OutMatrix[epoch-1,14]= model.state_dict()["MCPBRNNNode.relu_bj"][0][3] 
        OutMatrix[epoch-1,15]= model.state_dict()["MCPBRNNNode.ln_wj"][4][0]
        OutMatrix[epoch-1,16]= model.state_dict()["MCPBRNNNode.relu_bj"][0][4]  
