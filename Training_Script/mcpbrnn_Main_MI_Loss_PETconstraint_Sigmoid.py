...
CaseName = 'MCPBRNN_PETconstraint_Generic_' + str(depth_size) + 'Layer_1node_' + 'outdim' + str(gate_dim_o) + '_MI_lossdim' + str(gate_dim_l) + '_' + str(cfg["case_no"])  + '_Sigmoid'
directory = CaseName
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,6]= model.state_dict()["MCPBRNNNode.weight_b1_ylm"][:]
