...
Ini_dir ="results_MI/MI-Highdim/dim-o-1-dim-l-1/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_MI_lossdim1_1/model_epoch57.pt"
...
par_no = 7 + 2 # Temporarily not save the parameter value
skillmetric = 7
...
class Model_out(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_MIoutput_Sigmoid(input_size=input_size_dyn,
...
model_out = Model_out(input_size_dyn=input_size_dyn,
...
class Model_loss(nn.Module):
    ...
    def __init__(self,
        ...
        self.dropout_rate = dropout       
        self.batch_size = batch_size        
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_MIloss_Sigmoid(input_size=input_size_dyn,
                         hidden_size=hidden_size,
                         gate_dim_o=gate_dim_o,
                         gate_dim_l=gate_dim_l,
                         spinLen=spinLen,
...
weight_IC_file = "M5-case_Trial1/MCPBRNN_Generic_PETconstraint_Scaling_M5_1Layer_1node_1/model_epoch27.pt"
model_old.load_state_dict(torch.load(weight_IC_file))   
weight_IC_file = "MI-outGate-dim1-sigmoid/MCPBRNN_PETconstraint_Generic_1Layer_1node_MI_outdim1_lossdim1_4_Sigmoid/model_epoch905.pt"
model_out.load_state_dict(torch.load(weight_IC_file))           
weight_IC_file = "MI-lossGate-dim1-sigmoid/MCPBRNN_PETconstraint_Generic_1Layer_1node_outdim1_MI_lossdim1_9_Sigmoid/model_epoch17.pt"
...
model.state_dict()["MCPBRNNNode.bias_b0_yom"][:] = model_out.state_dict()["MCPBRNNNode.bias_b0_yom"][:]
model.state_dict()["MCPBRNNNode.weight_b1_yom"][:] = model_out.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
model.state_dict()["MCPBRNNNode.weight_b2_yom"][:] = model_out.state_dict()["MCPBRNNNode.weight_b2_yom"][:]
model.state_dict()["MCPBRNNNode.bias_b0_ylm"][:] = model_loss.state_dict()["MCPBRNNNode.bias_b0_ylm"][:]
model.state_dict()["MCPBRNNNode.weight_b1_ylm"][:] = model_loss.state_dict()["MCPBRNNNode.weight_b1_ylm"][:]
...
# Output time series
    ...
    OutMatrix[epoch-1,5]= model.state_dict()["MCPBRNNNode.weight_b2_yom"][:]    
    OutMatrix[epoch-1,6]= model.state_dict()["MCPBRNNNode.bias_b0_ylm"][:]
    OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.weight_b1_ylm"][:]    
...
# Save Results file
outtofile = pd.DataFrame(OutMatrix, columns=["MCPBRNNNode.weight_r_yom","MCPBRNNNode.weight_r_ylm","MCPBRNNNode.weight_r_yfm","MCPBRNNNode.bias_b0_yom","MCPBRNNNode.weight_b1_yom","MCPBRNNNode.weight_b2_yom","MCPBRNNNode.bias_b0_ylm","MCPBRNNNode.weight_b1_ylm","MCPBRNNNode.weight_b2_ylm",'NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
