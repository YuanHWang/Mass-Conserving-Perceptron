...
from MCPBRNN_lib_tools.MRZoo import MCPBRNN_PETconstraint_MassRelax_Regular
...
CaseName = 'MCPBRNN_PETconstraint_MCRelaxed_Generic_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
