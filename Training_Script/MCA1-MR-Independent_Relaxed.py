...
from MCPBRNN_lib_tools.MRZoo_Relaxed import MCPBRNN_PETconstraint_MassRelax_Indepedent
...
CaseName = 'MCPBRNN_PETconstraint_MCRelaxed_Generic_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + "_Relaxed_Independent"
directory = CaseName
# HPC
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.dropout_rate = dropout       
        self.batch_size = batch_size        
        self.MCPBRNNNode = MCPBRNN_PETconstraint_MassRelax_Indepedent(input_size=input_size_dyn,
                         hidden_size=hidden_size,
                         gate_dim=gate_dim,
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode.bias_b0_yrm"][:]
