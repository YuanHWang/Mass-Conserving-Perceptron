...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_variable_Out_constantLoss
...
CaseName = 'MCPBRNN_Generic_NOscaling_M3_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_variable_Out_constantLoss(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, c_mean, c_std):
        ...
        h_t, c_t, l_t, bp_t, i, oo, ol, f, h_nout, obs_std = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval, c_mean, c_std)    
...
weight_file = "M3-case_Trial1/MCPBRNN_Generic_NOscaling_M3_1Layer_1node_1/model_epoch4909.pt"
...
# Save Results file
outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
