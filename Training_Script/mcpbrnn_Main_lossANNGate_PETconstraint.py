...
from MCPBRNN_lib_tools.ComplexGateZoo import MCPBRNN_Generic_LossANNGate_PETconstraint
...
CaseName = 'MCPBRNN_Generic_' + str(depth_size) + 'Layer_1node_' + 'outGate_sigmoid_dim' + str(gate_dim_o) + '_lossGatedim' + str(gate_dim_l) + '_' + str(cfg["case_no"])
...
if gate_dim_l==2 and gate_dim_o==1: 
   Ini_dir = "ComplexG-loss-dim1/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim1_10/model_epoch1.pt"
elif gate_dim_l==3 and gate_dim_o==1:
   Ini_dir = "ComplexG-loss-dim2/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim2_4/model_epoch17.pt"
elif gate_dim_l==4 and gate_dim_o==1:
   Ini_dir = "ComplexG-loss-dim3/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim3_2/model_epoch1.pt"
elif gate_dim_l==5 and gate_dim_o==1:
   Ini_dir = "ComplexG-loss-dim4/MCPBRNN_Generic_1Layer_1node_outGate_sigmoid_dim1_lossGatedim4_6/model_epoch5.pt"
...
if gate_dim_l==2 and gate_dim_o==1:  
   ...
   model.state_dict()["MCPBRNNNode.bias_b0_yom"][:]= model_PET.state_dict()["MCPBRNNNode.bias_b0_yom"][:]
   model.state_dict()["MCPBRNNNode.bias_ln_ylm"][:]= model_PET.state_dict()["MCPBRNNNode.bias_b0_ylm"][:]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0]
   model.state_dict()["MCPBRNNNode.weight_b1_yom"][:] = model_cp.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][0] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][0]
   ...
   model.state_dict()["MCPBRNNNode.bias_ln_ylm"][:]= model_PET.state_dict()["MCPBRNNNode.bias_b0_ylm"][:]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][1][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][1][0]
   model.state_dict()["MCPBRNNNode.weight_b1_yom"][:] = model_cp.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][0] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][0]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][1] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][1]
   ...
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][1][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][1][0]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][2][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][2][0]
   model.state_dict()["MCPBRNNNode.weight_b1_yom"][:] = model_cp.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][0] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][0]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][1] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][1]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][2] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][2]
   ...
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][1][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][1][0]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][2][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][2][0]
   model.state_dict()["MCPBRNNNode.weight_b2_ylm"][3][0] = model_cp.state_dict()["MCPBRNNNode.weight_b2_ylm"][3][0]
   model.state_dict()["MCPBRNNNode.weight_b1_yom"][:] = model_cp.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][0] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][0]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][1] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][1]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][2] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][2]
   model.state_dict()["MCPBRNNNode.relu_bias_l"][0][3] = model_cp.state_dict()["MCPBRNNNode.relu_bias_l"][0][3]

elif gate_dim_l==1 and gate_dim_o==1:
...
for epoch in range(1,num_epochs+1): 
    ...
    if gate_dim_l==2:
      ...
      OutMatrix[epoch-1,5]= model.state_dict()["MCPBRNNNode.bias_ln_ylm"][:]
      ...
      OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode.relu_bias_l"][0][1]        
    elif gate_dim_l==3:
      OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
      OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
      OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
      ...
      OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode.relu_bias_l"][0][2] 
    elif gate_dim_l==4:
      OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
      OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
      OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
      ...
      OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode.relu_bias_l"][0][3]
    elif gate_dim_l==5:
      OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
      OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
      OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
      ...
      OutMatrix[epoch-1,15]= model.state_dict()["MCPBRNNNode.relu_bias_l"][0][4]
    elif gate_dim_l==1:
      OutMatrix[epoch-1,0]= model.state_dict()["MCPBRNNNode.weight_r_yom"][:]
      OutMatrix[epoch-1,1]= model.state_dict()["MCPBRNNNode.weight_r_ylm"][:]
      OutMatrix[epoch-1,2]= model.state_dict()["MCPBRNNNode.weight_r_yfm"][:]
      ...
      OutMatrix[epoch-1,5]= model.state_dict()["MCPBRNNNode.bias_ln_ylm"][:]
      OutMatrix[epoch-1,6]= model.state_dict()["MCPBRNNNode.weight_b2_ylm"][0][0]
      OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.relu_bias_l"][0][0]
...
# Save Results file
if gate_dim_l==2:
   outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','MCPBRNNNode.bias_ln_ylm','MCPBRNNNode.weight_b2_ylm_0','MCPBRNNNode.weight_b2_ylm_1','MCPBRNNNode.relu_bias_l_0','MCPBRNNNode.relu_bias_l_1','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
elif gate_dim_l==3:
   outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','MCPBRNNNode.bias_ln_ylm','MCPBRNNNode.weight_b2_ylm_0','MCPBRNNNode.weight_b2_ylm_1','MCPBRNNNode.weight_b2_ylm_2','MCPBRNNNode.relu_bias_l_0','MCPBRNNNode.relu_bias_l_1','MCPBRNNNode.relu_bias_l_2','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
elif gate_dim_l==4:
   outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','MCPBRNNNode.bias_ln_ylm','MCPBRNNNode.weight_b2_ylm_0','MCPBRNNNode.weight_b2_ylm_1','MCPBRNNNode.weight_b2_ylm_2','MCPBRNNNode.weight_b2_ylm_3','MCPBRNNNode.relu_bias_l_0','MCPBRNNNode.relu_bias_l_1','MCPBRNNNode.relu_bias_l_2','MCPBRNNNode.relu_bias_l_3','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
elif gate_dim_l==5:
   outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','MCPBRNNNode.bias_ln_ylm','MCPBRNNNode.weight_b2_ylm_0','MCPBRNNNode.weight_b2_ylm_1','MCPBRNNNode.weight_b2_ylm_2','MCPBRNNNode.weight_b2_ylm_3','MCPBRNNNode.weight_b2_ylm_4','MCPBRNNNode.relu_bias_l_0','MCPBRNNNode.relu_bias_l_1','MCPBRNNNode.relu_bias_l_2','MCPBRNNNode.relu_bias_l_3','MCPBRNNNode.relu_bias_l_4','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
elif gate_dim_l==1:
   outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','MCPBRNNNode.bias_ln_ylm','MCPBRNNNode.weight_b2_ylm_0','MCPBRNNNode.relu_bias_l_0','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])
