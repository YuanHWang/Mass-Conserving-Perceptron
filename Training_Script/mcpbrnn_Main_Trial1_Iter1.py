...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_Scaling
...
CaseName = 'MCPBRNN_Generic_Scaling_M4_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_Scaling(input_size=input_size_dyn,
...
weight_file = "M4-case_Trial1/MCPBRNN_Generic_Scaling_M4_1Layer_1node_7/model_epoch4921.pt"
